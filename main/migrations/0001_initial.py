# Generated by Django 5.1 on 2025-02-11 09:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(default='게시판', max_length=50, null=True)),
                ...
                ('is_complete', models.BooleanField(default=False, verbose_name='작성 상태')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to=main.models.post.image_upload_path)),
                ('caption', models.CharField(blank=True, max_length=255, null=True)),
                ('is_representative', models.BooleanField(default=False, verbose_name='대표 사진 여부')),
                ('image_group_id', models.PositiveIntegerField(default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('font', models.CharField(choices=[('nanum_gothic', '나눔고딕'), ('Noto Serif Korean', 'Noto Serif Korean'), ('Gaegu', 'Gaegu'), ('Nanum Pen Script', 'Nanum Pen Script'), ('Black And White Picture', 'Black And White Picture')], default='nanum_gothic', max_length=25)),
                ('font_size', models.IntegerField(choices=[(11, '11px'), (13, '13px'), (15, '15px'), (16, '16px'), (19, '19px'), (24, '24px'), (28, '28px'), (30, '30px'), (34, '34px'), (38, '38px')], default=15)),
